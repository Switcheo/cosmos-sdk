...
type ValidatorGovInfo struct {
	...
	DelegatorShares     math.Dec            // Total outstanding delegator shares
	DelegatorDeductions math.Dec            // Delegator deductions from validator's delegators voting independently
